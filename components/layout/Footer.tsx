...
export default function Footer() {
  return (
    <footer className="w-full bg-black/80 text-white py-6 px-4 border-t border-zinc-800 mt-auto">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <nav className="flex gap-6 text-sm">
          ...
          <Link href="/privacy" className="hover:text-pink-400 transition">Privacy</Link>
          <Link href="/terms" className="hover:text-pink-400 transition">Terms</Link>
          <Link href="/contact" className="hover:text-pink-400 transition">Contact</Link>
        </nav>
        <div className="flex gap-4">
          <a href="https://twitter.com/" target="_blank" rel="noopener" aria-label="Twitter" className="hover:text-pink-400 transition">
